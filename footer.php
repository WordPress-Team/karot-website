...
<!-- <img src="img_la.jpg" alt="LA" style="width:100%"> -->
    ...
    <div class="try-app">
        ...
        <p class="prag2">There is no commitment and no hidden fees with this app. 
            <br>
            If you are ready to budget, we are here for you. 
            <br>
            But you can try it and find out for yourself. 
        </p>
        <!-- <a href= "#"><button class="button2">Download App</button></a> -->
    </div>
